    ...
    <main className="flex-1 p-6 md:p-10 overflow-auto">
      ...
      <div className="bg-[#111] border border-zinc-800 rounded-2xl overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-800">
          ...
          <span className="text-zinc-600 text-xs font-mono">{brands.length} registros</span>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-zinc-900">
                {brands.map((brand) => (
                  <tr key={brand.id} className="hover:bg-zinc-900/50 transition-colors group">
                    {/* Logo */}
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-yellow-500/10 border border-yellow-500/20 flex items-center justify-center flex-shrink-0">
                          <Shield size={13} className="text-yellow-500" strokeWidth={2} />
                        </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`font-bold tabular-nums text-sm ${
                            brand._count.products > 0 ? "text-zinc-300" : "text-zinc-700"
                          }`}
                        >
                    ...
                    <td className="pr-6 pl-4 py-4">
                      <div className="flex items-center justify-end gap-3">
                        <Link
                          href={`/admin/marcas/${brand.id}/edit`}
