...
function DeleteButton({ disabled }: { disabled?: boolean }) {
  ...
  return (
    <button
      ...
      title={disabled ? "Tiene productos asignados" : "Eliminar modelo"}
...
export default function DeleteVehicleButton({
  ...
  const [, formAction] = useActionState<ActionState, FormData>(deleteVehicle, null);
          ...
          openModal(
            {
              ...
              description: label
                ...
                : "¿Estás seguro de que querés eliminar este modelo? Esta acción no se puede deshacer.",
